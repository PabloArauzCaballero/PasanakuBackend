...
| Artefacto | Estado |
| --- | --- |
| `docs/` — bóveda | **Completa**: 99 casos de uso, 305 entidades, 633 relaciones, 142 restricciones, 46 ADR |
...
Total vigente: **142 restricciones definidas**, todas citadas por al menos un caso.
