...
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON aportes.evento_dominio TO svc_aportes;
REVOKE UPDATE ON aportes.evento_consumido FROM svc_aportes;
REVOKE UPDATE ON auditoria.evento_dominio FROM svc_auditoria;
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON auditoria.evento_dominio TO svc_auditoria;
...
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON cumplimiento.evento_dominio TO svc_cumplimiento;
...
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON entregas.evento_dominio TO svc_entregas;
REVOKE UPDATE ON entregas.evento_consumido FROM svc_entregas;
REVOKE UPDATE ON erp.evento_dominio FROM svc_erp;
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON erp.evento_dominio TO svc_erp;
REVOKE UPDATE ON erp.evento_consumido FROM svc_erp;
REVOKE UPDATE ON garantia.evento_dominio FROM svc_garantia;
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON garantia.evento_dominio TO svc_garantia;
REVOKE UPDATE ON garantia.evento_consumido FROM svc_garantia;
REVOKE UPDATE ON grupos.evento_dominio FROM svc_grupos;
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON grupos.evento_dominio TO svc_grupos;
REVOKE UPDATE ON grupos.evento_consumido FROM svc_grupos;
REVOKE UPDATE ON identidad.evento_dominio FROM svc_identidad;
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON identidad.evento_dominio TO svc_identidad;
...
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON notificaciones.evento_dominio TO svc_notificaciones;
...
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON nucleo_financiero.evento_dominio TO svc_nucleo_financiero;
...
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON organizador.evento_dominio TO svc_organizador;
...
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON publicidad.evento_dominio TO svc_publicidad;
REVOKE UPDATE ON publicidad.evento_consumido FROM svc_publicidad;
REVOKE UPDATE ON tarifas.evento_dominio FROM svc_tarifas;
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON tarifas.evento_dominio TO svc_tarifas;
...
GRANT UPDATE (publicado_en, estado, intentos, tomado_en, tomado_por, ultimo_error, proximo_intento_en) ON transparencia.evento_dominio TO svc_transparencia;
