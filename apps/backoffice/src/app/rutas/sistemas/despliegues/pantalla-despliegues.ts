...
import { Despliegue, desplieguesSimulados, Interruptor, interruptoresSimulados, puedeConfirmar } from '../dominio/datos-simulados'
...
@Component({
  ...
  imports: [BandaDeProposito, TablaDeDatos, ChipEstado, InterruptorUI, Alerta, Dialogo, Campo],
  template: `
    ...
    <main>
      ...
      <section>
        <ap-tabla-de-datos [titulo]="'Despliegues'" [columnas]="columnasDespliegue" [filas]="despliegues">
...
export class PantallaDespliegues {
  ...
  protected readonly despliegues: Despliegue[] = desplieguesSimulados
  ...
  protected readonly interruptores = signal<Interruptor[]>(interruptoresSimulados)
