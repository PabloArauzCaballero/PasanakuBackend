...
@Component({
  selector: 'ap-reclamos',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'pagina' },
  imports: [CabeceraDePagina],
  template: `
    <main id="contenido">
      <ap-cabecera-de-pagina etiqueta="Atención al cliente" [titulo]="pagina.titulo" [bajada]="pagina.bajada" />
...
export class Reclamos {
  protected readonly pagina = contenido.paginas['reclamos']!
}
