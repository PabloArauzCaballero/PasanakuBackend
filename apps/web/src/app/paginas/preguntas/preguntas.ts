...
@Component({
  selector: 'ap-preguntas',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'pagina' },
  imports: [CabeceraDePagina],
  template: `
    <main id="contenido">
      <ap-cabecera-de-pagina etiqueta="Preguntas frecuentes" [titulo]="pagina.titulo" [bajada]="pagina.bajada" />
...
export class Preguntas {
  protected readonly pagina = contenido.paginas['preguntas']!
}
