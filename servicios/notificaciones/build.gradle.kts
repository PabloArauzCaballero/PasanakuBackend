// notificaciones — generado por scripts/nuevo_servicio.py
...
extra["pisoDeCobertura"] = 0.86
extra["pisoDeRamas"] = 0.82

aportaya {
    esquema.set("notificaciones")
    rol.set("svc_notificaciones")
}
