// transparencia — generado por scripts/nuevo_servicio.py
...
extra["pisoDeCobertura"] = 0.78
extra["pisoDeRamas"] = 0.67

aportaya {
    esquema.set("transparencia")
    rol.set("svc_transparencia")
}
