// entregas — generado por scripts/nuevo_servicio.py
...
extra["pisoDeRamas"] = 0.71
extra["pisoDelDominio"] = 0.71   // lineas Y ramas de dominio/

aportaya {
    esquema.set("entregas")
    rol.set("svc_entregas")
}
